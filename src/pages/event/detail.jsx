...
import DeleteModalEvent from "@/components/event/DeleteModalEvent";
      ...
      <div className="flex flex-col justify-center items-center bg-neutral-100">
        ...
        <div className="flex flex-col w-full justify-center items-center">
          ...
          <div className="flex flex-col items-start w-full px-[40px] sm:px-[100px] lg:px-[200px]">
            ...
            {JSON.parse(localStorage.getItem("dataUser")) === "ADMIN" ? (
              <div className="flex justify-center mt-[50px] w-full">
                <button
                  onClick={openDeleteModal}
                  className="text-white bg-red-700  py-4 mt-[10px] w-1/2 lg:mt-[0px] min-w-[200px] min-[770px]:ml-[-10px] px-5 text-[15px] rounded-full text-center shadow-lg font-medium"
                >
                  Delete Event
                </button>
              </div>
